...
final class PerfectSweepDToGTests: XCTestCase {
    ...
    func testTheSweepOpenedNoNewLines() {
        ...
        XCTAssertEqual(sizes["wanyamon"], 33, "Gogmamon, Grappleomon and the line's first two Megas, plus US-159's two" + ", plus US-160's one, plus US-161's RizeGreymon and Ravmon")
        XCTAssertEqual(sizes["penc-nso"], 86, "Fantomon, Flaremon and Apollomon, plus US-159's four" + ", plus US-160's five, plus US-161's Orochimon, plus US-163's seven Ultimates")
        XCTAssertEqual(sizes["penc-wg"], 53, "Delumon and Garudamon X, plus US-161's Paildramon")
        XCTAssertEqual(sizes["penc-nsp"], 47, "DarkKnightmon and DarkKnightmon X" + ", plus US-160's one, plus US-161's both Panjyamon, plus US-163's one Ultimate")
        XCTAssertEqual(sizes["penc-sw"], 26, "Gokuwmon and SeitenGokuwmon")
        XCTAssertEqual(sizes["penc-me"], 75, "Duramon, plus US-159's two" + ", plus US-160's one, plus US-161's both Okuwamon, RizeGreymon X and two Kuwagamon Megas, plus US-163's four Ultimates")
        XCTAssertEqual(sizes["penc-vb"], 62, "Entmon, plus US-161's Regulusmon, plus US-163's two Ultimates")
    ...
    func testTheTwentyTwoOrphansThisStoryRemovedAreAllPlainRosterIds() throws {
        ...
        XCTAssertEqual(graph.nodes(at: .ultimate).count, 236, "81 before this story, 88 after it, 93 after US-159, 98 after US-160, 105 after US-161, 108 after US-162, 138 after US-163")
    }

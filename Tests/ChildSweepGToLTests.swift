...
final class ChildSweepGToLTests: XCTestCase {
    ...
    func testTheSweepOpenedNoNewLines() {
        ...
        XCTAssertEqual(sizes["tamers"], 105, "US-152 hung two more Champions under it, US-154 six, US-156 two, US-157 eight, plus US-158's four, plus US-159's five" + ", plus US-160's four, plus US-161's Rapidmon and SaintGalgomon")
        XCTAssertEqual(sizes["dmc-v3"], 52)
        XCTAssertEqual(sizes["xros"], 21)
    ...
    func testTheFiftyOneOrphansThisStoryRemovedAreAllPlainRosterIds() throws {
        ...
        XCTAssertEqual(graph.nodes.count, 787,
                       "497 before this story, 548 after it, 599 after US-150, 610 after US-151, "
                           ...
                           + "672 after US-157, 693 after US-158, 709 after US-159, 736 after US-160, 760 after US-161, 787 after US-162")
    }

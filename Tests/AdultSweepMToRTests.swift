...
final class AdultSweepMToRTests: XCTestCase {
    ...
    func testTheSweepOpenedNoNewLines() {
        ...
        XCTAssertEqual(sizes["penc-vb"], 62, "Mikemon and Nefertimon X, plus US-156's two and US-157's four, plus US-158's Entmon, plus US-161's Regulusmon, plus US-163's two Ultimates")
        ...
        XCTAssertEqual(sizes["penc-nso"], 86, "Musyamon, plus US-157's Archnemon and BlueMeramon, plus US-158's three, plus US-159's four" + ", plus US-160's five, plus US-161's Orochimon, plus US-163's seven Ultimates")
        XCTAssertEqual(sizes["penc-wg"], 53, "RedV-dramon, plus US-156's two Black V-dramon, plus US-158's two, plus US-161's Paildramon")

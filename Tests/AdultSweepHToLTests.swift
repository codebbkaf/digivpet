...
final class AdultSweepHToLTests: XCTestCase {
    ...
    func testTheSweepOpenedNoNewLines() {
        ...
        XCTAssertEqual(sizes["penc-vb"], 57, "US-153 added KausGammamon, US-154 two more, US-156 two more, US-157 four, plus US-158's Entmon, plus US-161's Regulusmon, plus US-163's two Ultimates")
        XCTAssertEqual(sizes["penc-ds"], 45, "US-153 added Kinkakumon, US-154 MoriShellmon, US-157 Anomalocarimon X, plus US-158's Gusokumon, plus US-159's Hangyomon" + ", plus US-160's two, plus US-163's one Ultimate")

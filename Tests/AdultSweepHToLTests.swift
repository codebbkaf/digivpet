...
final class AdultSweepHToLTests: XCTestCase {
    ...
    func testTheSweepOpenedNoNewLines() {
        ...
        XCTAssertEqual(sizes["penc-vb"], 61, "US-153 added KausGammamon, US-154 two more, US-156 two more, US-157 four, plus US-158's Entmon, plus US-161's Regulusmon, plus US-163's two Ultimates")

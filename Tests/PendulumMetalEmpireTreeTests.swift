...
final class PendulumMetalEmpireTreeTests: XCTestCase {
    ...
    func testTwentyFourOfTheThirtyTwoNodesCarryAPlainRosterIdAndSoRemoveAnOrphan() throws {
        ...
        let sweepEggs: Set<String> = ["espi_digitama", "phasco_digitama",
                                      ...
                                      // US-159's two, hung off this line's own Omekamon — which
                                      // was a leaf until then, so the arrow cleared a dead end.
                                      ...
                                      "hi-andromon",
                                      // US-167's one: Rasenmon Fury Mode over Hisyaryumon.
                                      "rasenmon_fury"]
        ...
        XCTAssertEqual(mine.count, 35)
        XCTAssertEqual(plain.count, 27, "the orphan count in the notes is off")

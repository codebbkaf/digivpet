...
final class ChildSweepMToZTests: XCTestCase {
    ...
    func testTheSweepOpenedNoNewLines() {
        ...
        XCTAssertEqual(sizes["penc-me"], 59, "US-151 hung Deckerdramon on Hagurumon, US-157 six more nodes, plus US-158's Duramon, plus US-159's two" + ", plus US-160's one, plus US-161's both Okuwamon, RizeGreymon X and two Kuwagamon Megas")

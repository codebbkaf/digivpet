...
final class AdultSweepAToDTests: XCTestCase {
    ...
    func testTheSweepOpenedNoNewLines() {
        ...
        XCTAssertEqual(sizes["tamers"], 113, "US-151 added DarkLizamon, MegaloGrowmon, CatchMamemon; "
        ...
        XCTAssertEqual(sizes["dmc-v4"], 30, "US-151 added the two Burgermon, US-156 Xiquemon and Huankunmon")
        XCTAssertEqual(sizes["penc-wg"], 42,
        ...
        XCTAssertEqual(sizes["penc-vb"], 57,
        ...
        XCTAssertEqual(sizes["penc-me"], 67, "US-151 added Deckerdramon, US-157 five Perfects and Kazuchimon, plus US-158's Duramon, plus US-159's two" + ", plus US-160's one, plus US-161's both Okuwamon, RizeGreymon X and two Kuwagamon Megas, plus US-163's four Ultimates")
    }

...
final class PendulumNightmareSoldiersTreeTests: XCTestCase {
    ...
    func testEveryNodeInTheLineIsReachableFromItsDigitama() throws {
        ...
        XCTAssertEqual(inLine.count, 84,
    ...
    func testTheTwentyOneOrphansThisStoryRemovedAreTheNodesWithRosterIds() throws {
        ...
        let sweepEggs: Set<String> = ["cand_digitama", "picodevi_digitama", "vorvo_digitama",
                                      ...
                                      // US-159's four: Insekimon and Lavogaritamon over the leaf
                                      // Icemon and Lavorvomon this file already names, the
                                      // Volcanicdramon over the second, and Lucemon Falldown over
                                      ...
                                      // US-163's SEVEN, the largest single addition this line has
                                      // taken from a sweep and all of them Megas: Barbamon and
                                      // Barbamon X over Mephismon, BelialVamdemon over this line's
                                      // own Vamdemon, AncientMegatheriumon over Mammon, Blastmon
                                      // over Insekimon, and Algomon and AncientSphinxmon over
                                      // Mummymon — which is the only drawable parent Algomon has
                                      ...
                                      // US-165's two: GraceNovamon over Flaremon — drawn one rung
                                      // below its all-Ultimate parents — and GrandDracumon over
                                      // this line's own Vamdemon.
                                      "gracenovamon", "granddracumon",
                                      // US-167's three: Ogudomon over Mephismon, Ogudomon X over
                                      // Mephismon X, and Ordinemon over Lucemon Falldown Mode.
                                      "ogudomon", "ogudomon_x", "ordinemon"]
        XCTAssertEqual(graph.nodes.filter { $0.line == line && !sweepEggs.contains($0.id) }.count, 37)
